...
const TerminalController = () => {
  const [terminalLineData, setTerminalLineData] = useState([
    { type: LineType.Input, value: "What's your name?" },
  ]);
  return (
    <div className="container">
      <Terminal
        name="Nayoun's Terminal"
        colorMode={ColorMode.Dark}
        lineData={terminalLineData}
        onInput={(terminalInput) => {
          const reactTerminal = document.querySelector(".react-terminal");
          const spans = reactTerminal?.getElementsByTagName("span");
          setTerminalLineData([{ type: LineType.Input, value: terminalInput }]);
        }}
      />
    </div>
  );
